...
class SettingCategoryData {
	...
	public $records = array(
		...
		array(
			...
			'parent_id' => '15',
			'name' => 'Facebook',
			'description' => 'Facebook is used for login and posting message using its account details. For doing above, our site must be configured with existing Facebook account. <a target=\"_blank\" href=\"http://dev1products.dev.Ivica.com/doku.php?id=facebook-setup\"> http://dev1products.dev.Ivica.com/doku.php?id=facebook-setup </a>',
			'plugin_name' => ''
		),
		array(
			'id' => '49',
		...
		array(
			...
			'parent_id' => '15',
			'name' => 'Yahoo',
			'description' => 'We use this service for importing contacts from Yahoo for friends invite. For doing above, our site must be configured with existing Yahoo account. <a target=\"_blank\" href=\"http://dev1products.dev.Ivica.com/doku.php?id=yahoo-setup\"> http://dev1products.dev.Ivica.com/doku.php?id=yahoo-setup </a>',
			'plugin_name' => ''
		),
		array(
			'id' => '51',
		...
		array(
			...
			'description' => 'By enabling this, most of the pages will be disk-cached. This will avoid PHP and database access. Caveat of this approach is that users will be presented with little outdated contents. Since, this Ivica RBooking script is highly optimized for this approach, this is highly recommended for good performance. ',
			'plugin_name' => 'HighPerformance'
		),
		array(
			'id' => '74',
