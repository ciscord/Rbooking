<div class="install form">
	...
	<iframe frameborder="0" width="630px" height="80px" src="http://installer.dev.Ivica.com/info5.html"></iframe>
			<?php
	...
	<div class="content-block round-4">
	  ...
	  <?php 
			...
			echo $this->Form->input('Install.database', array('label' => __l('Name'), 'default' => 'RBooking'));
