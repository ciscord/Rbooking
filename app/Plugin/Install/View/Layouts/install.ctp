...
<head>
  ...
  <title><?php echo $this->Html->cText($title_for_layout, false); ?> - <?php echo __l('RBooking'); ?></title>
  ...
  <div class="container_24">
    <div class="header">
      <div class="h-left">
        <div class="h-right">
          <div class="h-center">
            <h1 class="grid_left"><a href="#" title="RBooking">RBooking</a></h1>
    ...
    <div class="main clearfix">
      <div class="side-content grid_7">
        ...
        <ol class="list round-4 grid_6">
          ...
          <li class="round-4<?php if ($this->request->params['action'] == 'configuration') { ?> active<?php } ?>">6. RBooking Configuration</li>
    ...
    <div class="footer">
      <div class="footer-inner clearfix">
        <p>&copy;<?php echo date('Y'); ?> <a title="RBooking" href="http://RBooking.dev.Ivica.com/">RBooking</a>. All rights reserved.</p>
        <p class="powered clearfix"><span><a class="powered" target="_blank" title="Powered by RBooking" href="http://RBooking.dev.Ivica.com/">Powered by RBooking</a>,</span>
        <span>made in</span><a class="company" title="Ivica Web Development" target="_blank" href="http://www.Ivica.com/">Ivica Web Development</a></p>
