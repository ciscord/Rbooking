  ...
  <body>
    <div id="<?php echo $this->Html->getUniquePageId();?>" class="content js-responses">
      ...
      <footer id="footer" class="top-mspace space clearfix">
        <div id="Ivica" class="container clearfix">
          ...
          <p class="powered clearfix span"><span  class="pull-left"><a href="http://RBooking.dev.Ivica.com" title="<?php echo __l('Powered by RBooking'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by RBooking'); ?></a> <span class="made-in pull-left">,<?php echo  'made in';?></span> <a class="company pull-left" title="<?php echo __l('Ivica Web Development'); ?>" target="_blank" href="http://www.Ivica.com/"><?php echo __l('Ivica Web Development'); ?></a> <span class="pull-left"><?php echo Configure::read('site.version');?></span></p>
