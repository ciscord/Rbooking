			...
			<div class="span18 clearfix">
				...
				<div class="clearfix top-space graydarkc pull-left">
					...
					<p class="clearfix span">
						<span class="pull-left"><a href="http://RBooking.dev.Ivica.com" title="<?php echo __l('Powered by RBooking'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by RBooking'); ?></a>,</span>
						<span class="pull-left"><?php echo __l('Made in'); ?></span><?php echo $this->Html->link(__l('Ivica Web Development'), 'http://www.Ivica.com/', array('target' => '_blank', 'title' => __l('Ivica Web Development'), 'class' => 'company pull-left'));?>  <span class="pull-left"><?php echo Configure::read('site.version');?></span></p>
