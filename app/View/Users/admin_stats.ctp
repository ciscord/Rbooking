  ...
  <section class="no-pad top-mspace">
	...
	<div class="ver-mspace textb graydarkc"><?php echo __l('Version').' ' ?>  <?php echo Configure::read('site.version'); ?></div>
      <ul class="unstyled bot-mspace">
        <li><i class="icon-angle-right "></i><?php echo $this->Html->link(__l('Product Support'), 'http://customers.Ivica.com/', array('class' => 'js-no-pjax', 'target' => '_blank', 'title' => __l('Product Support'))); ?> </li>
        <li><i class="icon-angle-right "></i> <?php echo $this->Html->link(__l('Product Manual'), 'http://dev1products.dev.Ivica.com/doku.php?id=RBooking' ,array('class' => 'js-no-pjax', 'target' => '_blank','title' => __l('Product Manual'))); ?> </li>
        ...
        <li><i class="icon-angle-right "></i> <?php echo $this->Html->link(__l('Ivica Blog'), 'http://blogs.Ivica.com/' ,array('class' => 'js-no-pjax', 'target' => '_blank','title' => __l('Ivica Blog'))); ?><small> <?php echo __l('Follow Ivica news');?></small> </li>
