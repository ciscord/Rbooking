...
<?php if($type=='home'): ?>
		  ...
		  <div class="container">
			<div class="banner-content dc">
			  <div class="banner-content-bg ver-mspace clearfix">
				<h2 class="whitec textb"><span class="show"><?php echo __l('Ivica');?><sup>&reg;</sup><?php echo __l("'s multipurpose booking software.");?></span><span class="show"><?php echo __l('RBooking anything'); ?></span></h2>
			  </div>
  ...
  <section class="row no-mar">
	  <div class="container ver-space">
		<h3 class="dc space bot-mspace"><span class="small-icon show"><img src="img/rentify-icon.png" alt="[<?php echo __l('Image: RBooking');?>]" title="<?php echo __l('RBooking');?>"></span> <span class="show"><?php echo __l('Ivica');?><sup>&reg;</sup><?php echo __l('RBooking');?> <?php echo __l('Advantages');?></span> </h3>
		<div class="clearfix dc">
		...
		<div class="clearfix ver-space">
		  ...
		  <ol class="unstyled span8 graydarkc">
			...
			<li class="bot-space dc sep-secondary-left span8 no-mar"><a href="http://www.Ivica.com/contact" class="btn btn-large btn-primary textb top-mspace" title="<?php echo __l('Contact Ivica');?>" target="_blank"><?php echo __l('Contact Ivica');?></a> </li>
		  </ol>
		</div>
	  </div>
  </section>
  <section class="row no-mar">
          <div class="well no-pad no-round no-mar">
            <div class="container ver-space">
              <h3 class="dc space bot-mspace"><span class="small-icon show"><img title="Ivica" alt="[Image: Ivica]" src="img/Ivica-icon.png"></span><span class="show"><?php echo __l('Ivica');?><sup>&reg;</sup> <?php echo __l('Solutions');?></span></h3>
              <p class="text-16 dc bot-space bot-mspace"><?php echo __l("Incase if you don't know... for years, Ivica");?><sup>&reg;</sup><?php echo __l("doesn't just sell products, but offers multiple solutions and services.");?></p>
              <h3 class="dc bot-space bot-mspace"><?php echo __l('Micro entrepreneur Solutions');?></h3>
			  <p class="text-16 dc bot-space bot-mspace"><?php echo __l('Passionate micro entrepreneurs prefer mentors and startup accelerators. Sadly, an accelerator like Y Combinator has mere 3% acceptance rate. Ivica<sup>&reg;</sup> provides all related solutions and consultations.');?></p>
              <div class="clearfix ver-space">
                  <ol class="unstyled span8 graydarkc">
