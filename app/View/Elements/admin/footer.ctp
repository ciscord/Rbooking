  <footer id="footer" class="sep-top sep-medium hor-space" itemscope itemtype="http://schema.org/WPFooter">
    <div class="container-fluid clearfix top-space">
      <div class="clearfix top-space graydarkc">
        ...
        <p class="clearfix span"><span class="pull-left"><a href="http://RBooking.dev.Ivica.com" title="<?php echo __l('Powered by RBooking'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by RBooking'); ?></a>,</span> <span class="pull-left"><?php echo __l('Made in'); ?></span> <?php echo $this->Html->link(__l('Ivica Web Development'), 'http://www.Ivica.com/', array('target' => '_blank', 'title' => __l('Ivica Web Development'), 'class' => 'company pull-left js-no-pjax'));?></p>
