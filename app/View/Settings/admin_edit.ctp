...
?>					
					...
					<fieldset class="form-block">
						...
						'##DEMO_URL##' => $this->Html->link('http://dev1products.dev.Ivica.com/doku.php?id=RBooking-install#how_to','http://dev1products.dev.Ivica.com/doku.php?id=RBooking-install#how_to', array('target' => '_blank')),
										);
